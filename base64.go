...
func init() {
	commands.RegisterCommand(Base64CommandName, &base64Command{}, nil)
}

// Base64CommandName returns the name of the command
const Base64CommandName commands.CommandName = "base64"
...
func (b *base64Command) Name() commands.CommandName {
